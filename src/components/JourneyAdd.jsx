        ...
        <div className="add-journey-background">
            <div className="add-journey-root">
                <div className="cancel-container">
                    <button className="cancel-journey-add add-cancel" onClick={() => navigate("/dashboard/main-panel")}>x</button>
                </div> 
                    ...
                    currentStage < numOfStages ? (
                        <form className="stage-form-add">
                            ...
                            <div className="input-container stage-input-container">
                                <input type="text" id={`stageTitle${currentStage}`} placeholder={`Title...`}/>
                            </div>
                            <div className="input-container ">
                                <textarea type="text" cols={40} rows={5} id={`stageDescription${currentStage}`} placeholder={`Description...`} />
                            </div>
                            <button className="next-button" onClick={e => handleNextStage(e)}>Next</button>
                        </form>
                    ) : <button className="next-button" onClick={e => handleNextStage(e)}>Submit</button>
                }
            </div>
        </div>
